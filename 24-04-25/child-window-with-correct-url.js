...
const allowedPatterns = [
  ...
  function createChildWindow() {
    const url = `https://verdant-vacherin-bb83a6.netlify.app/?locationId=${encodeURIComponent(currentLocationId)}`;
...
function loadReactApp() {
  if (!childWindow) return;
  const scriptUrl = 'https://cdn.jsdelivr.net/gh/mayank-m-sharma/testa@refs/heads/main/23-04-25/locId-with-script.js';
